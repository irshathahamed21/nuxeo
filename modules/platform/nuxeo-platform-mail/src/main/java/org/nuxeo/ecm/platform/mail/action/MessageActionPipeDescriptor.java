...
public class MessageActionPipeDescriptor {
    ...
    /**
     * @deprecated since 11.5, use {@link XEnable#ENABLE} standard attribute instead.
     */
    @Deprecated(since = "11.5")
    ...
    public Map<String, MessageActionDescriptor> getActionsMap() {
        return Stream.of(actions)
                     .collect(Collectors.toMap(MessageActionDescriptor::getId, Function.identity(), (e1, e2) -> e2,
                             LinkedHashMap::new));
    }
