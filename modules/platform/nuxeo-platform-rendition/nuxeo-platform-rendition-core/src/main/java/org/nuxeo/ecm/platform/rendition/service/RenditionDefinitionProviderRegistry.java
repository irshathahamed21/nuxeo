...
public class RenditionDefinitionProviderRegistry extends MapRegistry {
    ...
    protected Stream<RenditionDefinition> getRenditionDefinitionStream(DocumentModel doc) {
    ...
    public List<RenditionDefinition> getRenditionDefinitions(DocumentModel doc) {
        return getRenditionDefinitionStream(doc).collect(Collectors.toList());
    }
    ...
    public RenditionDefinition getRenditionDefinition(String name, DocumentModel doc) {
        ...
        return getRenditionDefinitionStream(doc).filter(rd -> name.equals(rd.getName())).findFirst().orElse(null);
    }
